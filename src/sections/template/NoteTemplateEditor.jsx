// NoteTemplateEditor.jsx
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
import axios from '../../api/axios';

export default function NoteTemplateEditor({ id, isNew, type }) {
  ...
  return (
    <div className="p-6 space-y-6">
      <h2 className="text-2xl font-bold">Note Template Editor</h2>
      <input
      ...
      <textarea
        ...
        placeholder="상담 중 메모 템플릿을 입력하세요."
      />
